...
|         | `@store/info_m`              |           | `상점 정보`        |                      |          |
|         | - @store/Info_M_300.0        | 300.0.0   | 기업형 상점정보      |                      | ms2008   |
|         | - @store/Info_M_301.0        | 301.0.0   | 개인형 상점정보      | 독립버전(호환-X)         | ms2008   |
|         | `@store/account_m`           |           | `계정`            |                      |          |
...
|         | `@member/info_m`             |           | `회원 정보`        |                      |          |
|         | - @member/Info_M_300.0       | 300.0.0   | 기업형 회원정보     |                       | ms2008   |
|         | - @member/Info_M_301.0       | 301.0.0   | 개인형 회원정보     | 독립버전(호환-X)         | ms2008   |
|         | `@member/`                   |           | `관심상품`         | TODO::               |          |
|         | `@member/`                   |           | `비회원`          |  TODO::               |         |
|         | `@member/account_m`          |           | `계정`            |                      |          |
|         | `@member/group_m`            |           | `계정그룹`         |                      |          |
...
| **BOD** |                              |           | **게시판**        |                      |          |
|         | `@board/notice_m`            |           | `공지사항`         |                      |          |
|         | - @board/Notice_M_300.0      | 300.0.0   | 공지사항 관리       |                      | ms2008   |
|         | `@board/faq_m`               |           | `질문/답변`        |                      |          |
